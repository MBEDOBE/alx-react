...
describe('App component', () => {
  it('defaults to displayDrawer being false', () => {
    const wrapper = shallow(<App />);
    expect(wrapper.state('displayDrawer')).toBe(false);
  });

  it('updates displayDrawer state to true after handleDisplayDrawer is called', () => {
    const wrapper = shallow(<App />);
    wrapper.instance().handleDisplayDrawer();
    expect(wrapper.state('displayDrawer')).toBe(true);
  });

  it('updates displayDrawer state to false after handleHideDrawer is called', () => {
    const wrapper = shallow(<App />);
